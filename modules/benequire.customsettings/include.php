...
class CBeneQuire_CustomSettingsOptions {
	...
	function IsLinksInstalled() {
		...
		if($bInstalled===true) {
			...
			$bInstalled=IsModuleInstalled("benequire.links");
			return $bInstalled;
		}
	...
	function ShowTab($gks_tab_id,$tab=Array(),$set_variables=true) {
		...
		<div class="gcustomsettings-settings-tab" id="gks_tab_<?=$gks_tab_id?>">
			...
			<table class="gcustomsettings-settings-tab-headers" cellspacing="0" cellpadding="0">
				<thead>
					<tr>
						<td><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_NAME")?></td>
						<td><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_HEADER")?></td>
					</tr>
				</thead>
				<tbody>
					<tr>
			...
			<div class="gcustomsettings-settings-option-add">
				<a href="#" onclick="gksAddOption('<?=$gks_tab_id?>'); return false;"><img src="/bitrix/images/benequire.customsettings/gcustomsettings_options_option_icon_add.gif" width="24" height="24" border="0" />&nbsp;&nbsp;<span><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_ADD_OPTION")?></span></a>
			</div>
		
			<a class="gcustomsettings-settings-tab-remove" href="#" onclick="if(confirm('<?echo AddSlashes(GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_REMOVE_TAB_WARNING"))?>')) gksRemoveTab('<?=$gks_tab_id?>'); return false"><img src="/bitrix/images/benequire.customsettings/gcustomsettings_options_tab_icon_remove.gif" width="30" height="15" border="0" />&nbsp;&nbsp;<span><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_REMOVE_TAB")?></span></a>
	...
	function ShowOption($gks_tab_id,$gks_option_id,$option=Array(),$set_variables=true) {
		...
		<div class="gcustomsettings-settings-option" id="gks_option_<?=$gks_tab_id?>_<?=$gks_option_id?>">
			...
			<table cellspacing="0" cellpadding="0" class="gcustomsettings-settings-option-table">
				<thead>
					<tr>
						<td><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_ID")?></td>
						<td><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_NAME")?></td>
						<td><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_TOOLTIP")?></td>
						<td><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_TYPE")?></td>
						<td><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_CUSTOM")?></td>
						<td>&nbsp;</td>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<td>
							<select name="TABS[<?=$gks_tab_id?>][FIELDS][<?=$gks_option_id?>][TYPE]" onChange="gksOptionChangeType('<?=$gks_tab_id?>','<?=$gks_option_id?>',this);">
								<option value="text"<?if($option["TYPE"]=="text"):?> selected="selected"<?endif?>><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_TYPE_TEXT")?></option>
								<option value="textarea"<?if($option["TYPE"]=="textarea"):?> selected="selected"<?endif?>><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_TYPE_TEXTAREA")?></option>
								<option value="checkbox"<?if($option["TYPE"]=="checkbox"):?> selected="selected"<?endif?>><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_TYPE_CHECKBOX")?></option>
								<option value="select"<?if($option["TYPE"]=="select"):?> selected="selected"<?endif?>><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_TYPE_SELECT")?></option>
								<option value="date"<?if($option["TYPE"]=="date"):?> selected="selected"<?endif?>><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_TYPE_DATE")?></option>
								<option value="file"<?if($option["TYPE"]=="file"):?> selected="selected"<?endif?>>Файл</option>
							</select>
						</td>
						<td width="99%">
						...
						<td>
							...
							<a class="gcustomsettings-settings-option-remove" href="#" onclick="gksRemoveOption('<?=$gks_tab_id?>','<?=$gks_option_id?>'); return false" title="<?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_REMOVE_OPTION")?>"><img src="/bitrix/images/benequire.customsettings/gcustomsettings_options_option_icon_remove.gif" width="24" height="24" border="0" /></a>
	...
	function ShowOptionCustom($gks_tab_id,$gks_option_id,$option,$set_variables=true) {
		...
		?>
			<table cellspacing="0" cellpadding="0"><tr>
				<td><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_CUSTOM_DEFAULT_VALUE")?></td>
			...
			<table cellspacing="0" cellpadding="0"><tr>
				<td><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_TAB_OPTION_TYPE_TEXT_SIZE")?></td>
		...
		?>
			...
			<table class="gcustomsettings-settings-selectvalue-table">
				<thead>
					<tr>
						<td class="gcustomsettings-settings-selectvalue-col-value"><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_SELECTVALUE_TD_VALUE")?></td>
						<td class="gcustomsettings-settings-selectvalue-col-name"><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_SELECTVALUE_TD_NAME")?></td>
			...
			<div class="gcustomsettings-settings-selectvalue-add">
				<a href="#" onclick="gksAddSelectValue('<?=$gks_tab_id?>','<?=$gks_option_id?>'); return false;"><img src="/bitrix/images/benequire.customsettings/gcustomsettings_options_option_icon_add.gif" width="16" height="16" border="0" />&nbsp;&nbsp;<span><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_SELECTVALUE_ADD")?></span></a>
			</div>
		...
		?>
			<?if(self::IsLinksInstalled()):?>
				<input type="button" style="margin: 5px 0" onclick="gksShowLinksDataSourcePopup('TABS[<?=$gks_tab_id?>][FIELDS][<?=$gks_option_id?>][LINK]','gks_column_linkparams_<?=$gks_tab_id?>_<?=$gks_option_id?>'); return false;" value="<?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_LINK_SET_UP_DATA_SOURCE")?>" />
				<div style="margin: 5px 0">
					<?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_LINK_INTERFACE_TYPE")?>:<br />
					<select name="TABS[<?=$gks_tab_id?>][FIELDS][<?=$gks_option_id?>][INTERFACE]">
						<option value="ajax"<?if($option["INTERFACE"]=="ajax"):?> selected="selected"<?endif?>><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_LINK_INTERFACE_AJAX")?></option>
						<option value="select"<?if($option["INTERFACE"]=="select"):?> selected="selected"<?endif?>><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_LINK_INTERFACE_SELECT")?></option>
						<option value="selectsearch"<?if($option["INTERFACE"]=="selectsearch"):?> selected="selected"<?endif?>><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_LINK_INTERFACE_SELECTSEARCH")?></option>
						<option value="search"<?if($option["INTERFACE"]=="search"):?> selected="selected"<?endif?>><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_LINK_INTERFACE_SEARCH")?></option>
					</select>
				</div>
				<label><table cellspacing="0" cellpadding="0"><tr>
					<td><?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_LINK_INTERFACE_SHOW_URL")?></td>
			...
			<?else:?>
				<?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_LINK_NOT_INSTALLED")?>
			<?endif?>
		<?
		break;
	...
	function ShowOptionSelectvalue($gks_tab_id,$gks_option_id,$gks_selectvalue_id,$value=Array(),$set_variables=true) {
		...
		<table cellspacing="0" cellpadding="0" class="gcustomsettings-settings-selectvalue-table">
	    	<tr>
	    		...
	    		<td class="gcustomsettings-settings-selectvalue-col-remove"><a href="#" onclick="gksRemoveSelectValue('<?=$gks_tab_id?>','<?=$gks_option_id?>','<?=$gks_selectvalue_id?>'); return false;" title="<?=GetMessage("BENEQUIRE_CUSTOMSETTINGS_OPTIONS_SETTINGS_SELECTVALUE_REMOVE")?>"><img src="/bitrix/images/benequire.customsettings/gcustomsettings_options_option_icon_remove.gif" width="16" height="16" border="0" /></a></td>
	    	</tr>
	    </table>

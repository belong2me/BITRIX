...
$now=time();
?>
<?if(defined("benequire_customsettings_OLDSITEEXPIREDATE")):?>
	<?if($now<benequire_customsettings_OLDSITEEXPIREDATE):?>
		<?echo BeginNote();?>
			<?
    		$expire_arr = getdate(benequire_customsettings_OLDSITEEXPIREDATE);
